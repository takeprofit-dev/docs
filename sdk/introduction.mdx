...
1. **Install the SDK**: Refer to the [Installation Guide](/sdk/installation) to set up the SDK within your project.
...
- [Installation Guide](/sdk/installation): Instructions for installing and setting up the SDK in your project.
- [Creating Your First Widget](/sdk/first-widget): Step-by-step guide for initializing and configuring your first widget.
- [SDK Reference](/api-reference): Comprehensive details on available classes, interfaces, and messaging protocols.
